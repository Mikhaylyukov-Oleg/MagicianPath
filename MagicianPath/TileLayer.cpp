...
TileLayer::TileLayer(int tileSize, int rowCount, int colCount, TileMap tileMap, TilesetList tilesets) : m_Tilesets (tilesets), m_RowCount(rowCount),
m_ColCount(colCount), m_TileMap(tileMap), m_TileSize(tileSize)
{
